...
int AMXAPI amx_Callback(AMX *amx, cell index, cell *result, cell *params)
{
  ...
  extern "C" int AMXAPI asm_runJIT(void *sourceAMXbase, void *jumparray, void *compiledAMXbase, AMX* amxptr);
#endif
...
int AMXAPI amx_InitJIT(AMX *amx, void *reloc_table, void *native_code)
{
  ...
  if ((res = asm_runJIT(amx->base, reloc_table, native_code, amx)) == 0) 
  {
