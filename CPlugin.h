...
public:
	...
	class CPlugin
	{
		...
		CPlugin(int i, const char* p, const char* n, char* e, int d, int profiling = 0);
		~CPlugin();
...
public:
	...
	CPlugin* loadPlugin(const char* path, const char* name, char* error, int debug, int profiling = 0);
